          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/ArelyX1/download-videos-audio-from-youtube" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Plataforma de instalación de videos o audios con python</h3>
              <p>
                Me canse de instalar videos o audio de yt en paginas inseguras.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/ArelyX1/GGJ2025" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Go Bubble</h3>
              <p> Videojuego presentado para la Global Game Jam desarrollado en 2 días en la USCP. </p>
            </div>
            <footer> <ul className="tech-list"> <li>Godot</li> <li>Blender</li> <li>C#</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/ArelyX1/PachaV0.6" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
              </div>
            </header>
            <div className="body">
              <h3>Pacha</h3>
              <p>
                Proyecto presentado para la hackaton Innova Sur 2024, desarrollado en 12 horas consecutivas para el reto de apoyo psicológico gracias a una app con un chatbot con la API de Perplexity.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/ArelyX1/Sistema-de-remuneraciones---Lady-Stardust" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Sistema de Remuneraciones</h3>
              <p>Sistema desarrollado para la tienda Lady Stardust, desarrollado como programador Full Stack.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Java</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/ArelyX1/Explanets-Delivery" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Exoplanets Delivery</h3>
              <p>Videojuego de aprendizaje desarrollado para la hackaton Nasa Space Apps.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Unity</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/ArelyX1/ADYX1_bot_Telegram" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
            ...
            <div className="body">
              ...
              <p>
                Bot para Telegram con fines de experimentación.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
